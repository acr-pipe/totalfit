<?php /* Smarty version 2.6.17, created on 2020-10-14 18:08:50
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../assets/css/modulos/login.css">

</head>

<body class="text-center">
<form class="form-signin" id="logF" action="index.php" method="POST" role="form">
<input type="hidden" name="vdir" id="vdir" value="">
<img class="mb-4" src="../assets/img/prev.svg" alt="" width="72" height="72">
<h1 class="h3 mb-3 font-weight-normal">Inicio de sesión</h1>
<label for="inputEmail" class="sr-only">Usuario</label>
<input id="user" type="email" class="form-control" name="usr" placeholder="Usuario" autocomplete="off" value="" required autofocus>
<label for="inputPassword" class="sr-only">Contraseña</label>
<input type="password" class="form-control passs" id="pass" name="pss" aria-describedby="passlHelp" placeholder="Contraseña" autocomplete="new-password" value="" required>
<div class="checkbox mb-3">
  <label>
    <input type="checkbox" value="remember-me"> Recordarme
  </label>
</div>
<button class="btn btn-lg btn-block btn-purple" id="loging" type="submit">Ingresar</button>
<p class="mt-5 mb-3 text-muted">&copy; 2020 pipe</p>
</form>
</body>
